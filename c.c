...
/* --- fhkl fuer si */
    ...
    s_wsle(&io___6);
    do_lio(&c__9, &c__1, "sk :", 4L);
    d__1 = z_abs(&sk);
    do_lio(&c__5, &c__1, (char *)&d__1, (ftnlen)sizeof(doublereal));
    do_lio(&c__9, &c__1, " dh :", 5L);
    do_lio(&c__5, &c__1, (char *)&dh, (ftnlen)sizeof(doublereal));
    e_wsle();
    if (*imat == 1) {
	astar = 5.43102018;
    }
...
/* Computing 3rd power */
    ...
    s_wsle(&io___13);
    do_lio(&c__9, &c__1, "f + fp:", 7L);
    d__1 = f + fp;
    do_lio(&c__5, &c__1, (char *)&d__1, (ftnlen)sizeof(doublereal));
    do_lio(&c__9, &c__1, " fpp :", 6L);
    do_lio(&c__5, &c__1, (char *)&fpp, (ftnlen)sizeof(doublereal));
    e_wsle();
...
/*      write(6,*) ' atomfor ..' */
    if (*imat == 1) {
	spline_(thovlm, matscf, &c__20, &c_b33, &c_b33, y_spline__);
    }
    if (*imat == 2) {
	spline_(thc, mc, &c__20, &c_b33, &c_b33, y_spline__);
    }
    if (*imat == 3) {
	spline_(thovlm, mge, &c__20, &c_b33, &c_b33, y_spline__);
    }
...
integer *imat;
{
    ...
    /* Fortran I/O blocks */
    static cilist io___30 = { 0, 11, 1, 0, 0 };
    static cilist io___34 = { 1, 11, 0, 0, 0 };
...
/* --- spline koeffizienten bestimmen */
    ...
    spline_(transfer_1.en, transfer_1.fp, &ndata, &c_b33, &c_b33, 
	    transfer_1.fps);
    spline_(transfer_1.en, transfer_1.fpp, &ndata, &c_b33, &c_b33, 
	    transfer_1.fpps);
